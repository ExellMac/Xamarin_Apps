...
namespace Calculator
{
    public partial class MainPage : ContentPage
    {
        ...
        private void OnSelectOperator(object sender, EventArgs e) //event is called when the select operator is called 
        {
            currentState = -2;
            Button button = (Button)sender;
            string pressed = button.Text;
        ...
        private void OnClear(object sender, EventArgs e) // this method is called when we press the AC button
        {
            firstNumber = 0;
            secondNumber = 0;
            currentState = 1;
        ...
        private void OnPercentage(object sender, EventArgs e) //This method is useful when we are going to find out percentage of last resulting variable or the initial variable
        {
        ...
        private void OnCalculate(object sender, EventArgs e) //This method is called when we have both first number and second number and we are going to evaluate those number
        {
            if (currentState == 2)
            {
                var result = OperationHelper.Calculate(firstNumber, secondNumber, myOperator);
        ...
        private void OnSquareRoot(object sender, EventArgs e) //We call this event when we have one resulting number or initial number ,we are going to find out the square root of that number
        {
        ...
        private void Potency(object sender, EventArgs e)//We call this method when we have one resulting number or initial number ,we are going to find out the square root of that number
        {
